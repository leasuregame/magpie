...
var PlayerTournamentLabel = cc.Layer.extend({
    ...
    init: function () {
        ...
        this._tournamentCountLabel = cc.LabelTTF.create("每天有奖挑战次数：战到你爽", 'Times New Roman', 30);
        ...
        this._rankLabel = cc.LabelTTF.create("排名：", 'Times New Roman', 30);
        ...
        this._abilityLabel = cc.LabelTTF.create("战斗力：", 'Times New Roman', 30);

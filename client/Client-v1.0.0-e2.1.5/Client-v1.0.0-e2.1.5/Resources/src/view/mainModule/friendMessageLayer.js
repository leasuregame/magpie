...
var FriendMessageLayer = cc.Layer.extend({
    ...
    update: function () {
        ...
        for (var i = 0; i < len; ++i) {
            ...
            var msgLabel = cc.LabelTTF.create(friendMessageList[i].content, "黑体", 22);
            msgLabel.setAnchorPoint(cc.p(0, 0.5));
            msgLabel.setPosition(cc.p(20, y + 60));
            scrollViewLayer.addChild(msgLabel);

            var timeLabel = cc.LabelTTF.create(this._getTimeStr(friendMessageList[i].createTime), "黑体", 16);

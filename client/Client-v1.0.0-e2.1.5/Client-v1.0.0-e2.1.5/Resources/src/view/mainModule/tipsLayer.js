...
var TipsLayer = LazyLayer.extend({
    ...
    init: function () {
        ...
        title.setPosition(cc.p(winSize.width / 2,1000));
        this.addChild(title);
        ...
        //天道描述
        y = scrollViewHeight - 35 - 30 - 220 * 2;
        ...
        //竞技描述
        y = scrollViewHeight - 35 - 30 - 220 * 3;
        ...
        //好友描述
        y = scrollViewHeight - 35 - 30 - 220 * 4;
        var description = lz.format('你可以通过祝福好友来获取活力值，活力值可以代替元宝进行卡牌召唤。', 28);
        this.addDescription(description, y , scrollViewLayer);

        //VIP描述
        y = scrollViewHeight - 35 - 30 - 220 * 5;
        ...
        //卡牌升级
        y = scrollViewHeight - 35 - 30 - 220 * 6;
        ...
        //技能升级
        y = scrollViewHeight - 35 - 30 - 220 * 7;
        ...
        //被动洗练
        y = scrollViewHeight - 35 - 30 - 220 * 8;
        ...
        //星级进阶
        y = scrollViewHeight - 35 - 30 - 220 * 9;
        ...
        //属性培养
        y = scrollViewHeight - 35 - 30 - 220 * 10;
    ...
    addDescription: function (desc,y,parent) {
        for(var i = 0;i < desc.length;i++) {
            var itemText = StrokeLabel.create(desc[i], "STHeitiTC-Medium", 20);
           // y = scrollViewHeight - 35 - id * 315;
            itemText.setAnchorPoint(cc.p(0, 0));
            itemText.setPosition(cc.p(10, y - i * 20));

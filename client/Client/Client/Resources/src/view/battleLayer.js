...
//        EffectsFactory.init();
    ...
    newBattle : function(json) {
        ...
        BattlePlayer.getInstance().play(battleLog.getBattleSteps(), this._cardsList, this._labelsList, this._progressList);
    },
    ...
    formation : function(battleLog) {
        ...
        for(var i = 0; i < 12; ++i) {
            if(this._cardsList[i]) this._cardsList[i].removeFromParent();
            if(this._progressList[i]) this._progressList[i].removeFromParent();

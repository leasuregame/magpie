...
set -x
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${CXX_GENERATOR_ROOT}/HttpClientPackage/HttpClientPackage.ini -s HttpClientPackage -o ./HttpClientPackage_bindings

...
var PlayerTournamentLabel = cc.Layer.extend({
    ...
    init: function () {
        ...
        this._nameLabel = cc.LabelTTF.create("名字：", "STHeitiTC-Medium", 30);
        this._nameLabel.setFontSize(25);
        this._nameLabel.setAnchorPoint(cc.p(0, 0.5));
        this._nameLabel.setPosition(100, 90);
        this.addChild(this._nameLabel);

        this._expLabel = cc.LabelTTF.create("经验：", "STHeitiTC-Medium", 30);
        ...
        this._tournamentCountLabel = cc.LabelTTF.create("每天有奖挑战次数：战到你爽", "STHeitiTC-Medium", 30);
        ...
        this._rankLabel = cc.LabelTTF.create("排名：", "STHeitiTC-Medium", 30);
        ...
        this._abilityLabel = cc.LabelTTF.create("战斗力：", "STHeitiTC-Medium", 30);

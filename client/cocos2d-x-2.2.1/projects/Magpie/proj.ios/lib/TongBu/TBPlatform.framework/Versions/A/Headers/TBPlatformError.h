...
#define TB_PLATFORM_LOGIN_INCORRECT_ACCOUNT_OR_PASSWORD_ERROR 2    /*账号或密码错误*/
#define TB_PLATFORM_LOGIN_INVALID_ACCOUNT_ERROR               3    /*账号被禁用*/
#define TB_PLATFORM_LOGIN_SYNC_FAILED_ERROR                   300  /*账号同步出错*/

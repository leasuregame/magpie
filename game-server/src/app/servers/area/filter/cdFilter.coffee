...
limitRouteMap = {
  'area.taskHandler.passBarrier': timeout: 1000, msg: '爬塔过于频繁，3秒后再试'
  'area.taskHandler.explore': timeout: 1000, msg: '探索过于频繁'
  'area.rankHandler.challenge': timeout: 1000, msg: '挑战过于频繁，请3秒钟后重试'
}
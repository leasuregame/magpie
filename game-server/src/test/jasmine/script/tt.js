...
Driver = {
  add: function(key, value, cb) {
    return mc.add(key.toString(), value, 0, cb);
  },
  set: function(key, value, cb) {
    return mc.set(key.toString(), value, 0, cb);
  },
  get: function(key, cb) {
    return mc.get(key.toString(), function(err, data) {
      return cb(err, data);
    });
  },
  ...
  del: function(key, cb) {
    return mc.del(key.toString(), function(err, data) {
      return cb(err, data);
    });
  },
  inc: function(key, cb) {

...
var cdkey = function(app) {
     ...
     * render cdkey
     */
    app.get('/admin/cdkey', filter.authorize, function (req, res) {
    ...
    /**
     * get cdkey pregenerate
     */
    app.get('/admin/cdkey/pregenerate', filter.authorize, function (req, res) {
    ...
    /**
     * generate cdkey and return
     */
    app.get('/admin/cdkey/generate', filter.authorize, function (req, res) {
     ...
     * search cdkey
     */
    app.get('/admin/cdkey/search', filter.authorize, function (req, res) {
